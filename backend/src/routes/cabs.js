...
const { searchCabs, getCabDetails } = require('../controllers/cabController');
const { authenticate } = require('../middleware/auth');

const router = express.Router();

// Validation for cab search
const searchValidation = [
  ...
  body('aiAgent')
    .optional()
    .isBoolean()
    .withMessage('AI Agent must be a boolean value')
];

// Routes
router.post('/search', authenticate, searchValidation, searchCabs);
router.get('/details/:cabId', authenticate, getCabDetails);
